...
public class Mitglied extends Gast {
    ...
    public Mitglied(String personenID, String nachname, String vorname, String email, String password, String anschrift, String mitgliedsnr, int telefonnummer, boolean spender, Mahnungsverwaltung mahnungen, Profilseite profilseite, LocalDateTime mitlglied_seit){
